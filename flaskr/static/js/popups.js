// ----------------------------
    ...
    const nodes = {
      start: {
        text: "Time to try again! Do you want to go to the next level?",
        yes: "node3",
        no: "node2"
      },
      ...
      node8: {
        text: "Do you want to play some russian roulette?",
        yes: "node13",
        no: "node9"
      },
      ...
      node13: {
        text: "Damn, you freaky... Back to the start for you.",
        yes: "start",
